                    ...
                    <form method="POST" action="{{ route('tenaga-ahli.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="nama_tenaga_ahli" class="block mt-1 w-full" type="text" name="nama_tenaga_ahli" :value="old('nama_tenaga_ahli')" required autofocus />
                            ...
                            <div>
                                ...
                                <select id="profesi" name="profesi" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                    ...
                                    <option value="Pelatih" {{ old('profesi') == 'Pelatih' ? 'selected' : '' }}>Pelatih</option>
                                    <option value="Wasit/Juri" {{ old('profesi') == 'Wasit/Juri' ? 'selected' : '' }}>Wasit/Juri</option>
                                    <option value="Guru PJOK" {{ old('profesi') == 'Guru PJOK' ? 'selected' : '' }}>Guru PJOK</option>
                                    <option value="Instruktur Senam" {{ old('profesi') == 'Instruktur Senam' ? 'selected' : '' }}>Instruktur Senam</option>
                                </select>
                            ...
                            <div>
                                ...
                                <x-text-input id="nomor_sertifikat" class="block mt-1 w-full" type="text" name="nomor_sertifikat" :value="old('nomor_sertifikat')" />
                            ...
                            <div>
                                ...
                                <select id="tingkat_lisensi" name="tingkat_lisensi" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                    ...
                                    <option value="Internasional" {{ old('tingkat_lisensi') == 'Internasional' ? 'selected' : '' }}>Internasional</option>
                                    <option value="Nasional" {{ old('tingkat_lisensi') == 'Nasional' ? 'selected' : '' }}>Nasional</option>
                                    <option value="Daerah" {{ old('tingkat_lisensi') == 'Daerah' ? 'selected' : '' }}>Daerah</option>
                                    <option value="Belum Berlisensi" {{ old('tingkat_lisensi') == 'Belum Berlisensi' ? 'selected' : '' }}>Belum Berlisensi</option>
                                </select>
