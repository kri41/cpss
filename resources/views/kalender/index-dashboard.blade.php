...
<div class="flex flex-col min-h-[calc(100vh-4rem)] px-4 sm:px-6 lg:px-8 pb-4">
    <!-- Header Kalender -->
    ...
    <!-- Calendar Grid -->
    <div class="flex-1 bg-white border border-gray-200 rounded-b-xl overflow-hidden min-h-[500px]">
        <!-- Header Hari -->
