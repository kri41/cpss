<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-amber-50 border border-amber-200 rounded-2xl p-5 flex items-start gap-3">
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center justify-between gap-2">
                            <h4 class="text-sm font-bold text-amber-900">{{ $p->judul }}</h4>
                            @if(auth()->user()->isAdmin())
                            <a href="{{ route('pengumuman.index') }}" class="text-xs font-medium text-amber-700 hover:text-amber-900 underline shrink-0">Edit</a>
                            @endif
                        </div>
                        <p class="text-sm text-amber-800 mt-1 whitespace-pre-line">{{ $p->isi }}</p>
                    </div>
                </div>
                @endforeach
            </div>
            ...
            <div class="mb-8">
                <a href="{{ route('pengumuman.index') }}" class="inline-flex items-center gap-2 text-sm text-blue-600 hover:text-blue-800 font-medium">
