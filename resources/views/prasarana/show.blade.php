            ...
            <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                <div class="flex-1">
                    <div class="flex items-center gap-3 mb-3 flex-wrap">
                        @foreach($prasarana->jenisOlahraga as $j)
                            <span class="px-3 py-1 text-xs font-semibold rounded-full bg-sky-100 text-sky-700">{{ $j->nama }}</span>
                        @endforeach
                ...
                <div class="flex items-center gap-2 shrink-0">
                    <a href="{{ auth()->check() ? route('dashboard.prasarana') : route('prasarana.index') }}" class="px-4 py-2 bg-white border border-gray-200 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 hover:border-gray-300 transition shadow-sm">
                        Kembali
                    </a>
                    @auth
                ...
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <p class="text-xs text-gray-500">Klub / Komunitas Terdaftar</p>
                                <p class="font-semibold text-gray-900">
                                    @if($prasarana->clubs->isEmpty())
                                        -
                                    @else
                                        {{ $prasarana->clubs->pluck('nama_club')->implode(', ') }}
                                    @endif
                                </p>
                            </div>
                        </div>
