                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input id="club_komunitas" type="text" name="club_komunitas" value="{{ old('club_komunitas', $prasarana->club_komunitas) }}" class="mt-1 block w-full rounded-lg border-slate-300 focus:border-sky-500 focus:ring-sky-500 shadow-sm" placeholder="Opsional">
                                ...
                                <div>
                                    ...
                                    <input id="kategori_olahraga" type="text" name="kategori_olahraga" value="{{ old('kategori_olahraga', $prasarana->kategori_olahraga) }}" required class="mt-1 block w-full rounded-lg border-slate-300 focus:border-sky-500 focus:ring-sky-500 shadow-sm" placeholder="Contoh: Sepakbola, Voli, Basket">
