...
@section('content')
<!-- Sticky Filter & Stats Bar -->
<div class="sticky top-16 z-30 bg-gray-50/95 backdrop-blur border-b border-gray-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <!-- Filter Row -->
        <form method="GET" action="{{ route('prasarana.index') }}" class="flex flex-wrap items-end gap-3 mb-4">
