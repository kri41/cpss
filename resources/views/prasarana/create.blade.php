        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('prasarana.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="nama_fasilitas" class="block mt-1 w-full" type="text" name="nama_fasilitas" :value="old('nama_fasilitas')" required autofocus />
                            ...
                            <div>
                                ...
                                <x-text-input id="club_komunitas" class="block mt-1 w-full" type="text" name="club_komunitas" :value="old('club_komunitas')" placeholder="Contoh: Club Sepakbola Merdeka" />
                            ...
                            <div>
                                ...
                                <x-text-input id="kategori_olahraga" class="block mt-1 w-full" type="text" name="kategori_olahraga" :value="old('kategori_olahraga')" required placeholder="Contoh: Sepakbola, Voli, Basket, dll" />
                            ...
                            <div>
                                ...
                                <x-text-input id="latitude" class="block mt-1 w-full" type="number" step="any" name="latitude" :value="old('latitude')" placeholder="-6.123456" />
                            ...
                            <div>
                                ...
                                <x-text-input id="longitude" class="block mt-1 w-full" type="number" step="any" name="longitude" :value="old('longitude')" placeholder="106.123456" />
                            ...
                            <div>
                                ...
                                <select id="kondisi_lantai" name="kondisi_lantai" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                    ...
                                    <option value="Baik" {{ old('kondisi_lantai') == 'Baik' ? 'selected' : '' }}>Baik</option>
                                    <option value="Sedang" {{ old('kondisi_lantai') == 'Sedang' ? 'selected' : '' }}>Sedang</option>
                                    <option value="Rusak Berat" {{ old('kondisi_lantai') == 'Rusak Berat' ? 'selected' : '' }}>Rusak Berat</option>
                                </select>
                            ...
                            <div class="flex items-center mt-8">
                                <input id="akses_disabilitas" type="checkbox" name="akses_disabilitas" value="1" {{ old('akses_disabilitas') ? 'checked' : '' }} class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
