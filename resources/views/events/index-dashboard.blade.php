...
<div x-data="{ verifyOpen: false, unverifyOpen: false, selected: null }">
    ...
    <div class="sticky top-14 lg:top-0 z-30 bg-gray-50/95 backdrop-blur border-b border-gray-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            ...
            <!-- Filter Row -->
            <form method="GET" action="{{ route('dashboard.events') }}" class="flex flex-wrap items-end gap-3">
