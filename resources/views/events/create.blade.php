                    ...
                    <form method="POST" action="{{ route('events.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <x-text-input id="nama_event" class="block mt-1 w-full" type="text" name="nama_event" :value="old('nama_event')" required autofocus placeholder="Contoh: Kejuaraan Sepakbola Antar Desa" />
                            ...
                            <div>
                                ...
                                <x-text-input id="tanggal_selesai" class="block mt-1 w-full" type="date" name="tanggal_selesai" :value="old('tanggal_selesai')" />
