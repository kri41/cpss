...
<div class="sticky top-14 z-30 bg-white/90 backdrop-blur border-b border-gray-200/80">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 sm:py-4">
        ...
        <!-- Filter Row -->
        <form method="GET" action="{{ route('clubs.index') }}" class="flex flex-wrap items-end gap-2 sm:gap-3">
            <div class="w-full">
            ...
            <div class="flex-1 min-w-[calc(50%-4px)] sm:flex-none sm:min-w-0 sm:w-32">
            ...
            <div class="w-full sm:w-auto flex flex-wrap gap-2">
                ...
                <a href="{{ route('clubs.index') }}" class="px-4 py-2 bg-white border border-gray-300 text-gray-600 text-sm font-medium rounded-lg hover:bg-gray-50 transition shadow-sm">Reset</a>
            </div>
        </form>
    </div>
</div>
...
@push('mascot')
<div class="hidden lg:block fixed bottom-0 right-4 z-10 pointer-events-none select-none">
    <img src="/storage/karakter/3.png" alt="" class="h-48 xl:h-56 w-auto object-contain object-bottom drop-shadow-xl">
</div>
@endpush
