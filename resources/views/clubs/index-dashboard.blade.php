        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            ...
            <form method="GET" action="{{ route('dashboard.clubs') }}" class="flex flex-wrap items-end gap-3">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('export.clubs', request()->query()) }}" class="flex items-center gap-1.5 px-4 py-2 bg-emerald-600 text-white text-sm font-medium rounded-lg hover:bg-emerald-700 transition shadow-sm" title="Export data yang sedang ditampilkan ke CSV/Excel">
